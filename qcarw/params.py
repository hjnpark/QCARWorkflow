...
def parse_refine_args(*args):
    ...
    grp_optparam.add_argument('--tsbasis', type=str, help='Basis set for transition state structure optimization, default = 6-31+g(d)')   
    ...
    grp_nebparam.add_argument('--nebmethod', type=int, help='Electronic structure method, default = b3lyp\n') 
    grp_nebparam.add_argument('--nebbasis', type=int, help='Basis set, default = 6-31+g(d)\n')
...
def parse_neb_args(*args):
    ...
    grp_nebparam.add_argument('--images', type=int, help='Number of images im the NEB chain, default = 21\n')
    grp_nebparam.add_argument('--method', type=int, help='Electronic structure method, default = b3lyp\n') 
    grp_nebparam.add_argument('--basis', type=int, help='Basis set, default = 6-31+g(d)\n')
